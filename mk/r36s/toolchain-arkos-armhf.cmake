# CMake toolchain: armhf Windstille → R36S / ArkOS (optional PortMaster-style ABI)
#
# Usage:
...
#     -DWINDSTILLE_USE_GLES=ON -DWINDSTILLE_ENABLE_SOUND=ON
#
...
set(WINDSTILLE_USE_GLES      ON  CACHE BOOL "OpenGL ES 2.0 (Mali-G31 / KMSDRM)" FORCE)
set(WINDSTILLE_ENABLE_SOUND  ON  CACHE BOOL "wstsound audio" FORCE)
set(WINDSTILLE_NO_XDGCPP     ON  CACHE BOOL "No xdgcpp on embedded CFW" FORCE)
