...
LOCAL_CFLAGS += -DUSE_SDL2 -DANDROID -DWINDSTILLE_USE_GLES=1 -DWSTDISPLAY_USE_GLES=1 -DGLM_ENABLE_EXPERIMENTAL -DSURF_USE_STB_IMAGE=1
LOCAL_CPPFLAGS += -DUSE_SDL2 -DANDROID -DWINDSTILLE_USE_GLES=1 -DWSTDISPLAY_USE_GLES=1 -DGLM_ENABLE_EXPERIMENTAL -DSURF_USE_STB_IMAGE=1 -std=c++23 -fexceptions -D_LIBCPP_ENABLE_EXPERIMENTAL=1
LOCAL_CFLAGS += -DWSTSOUND_WITH_MODPLUG=1
LOCAL_CPPFLAGS += -DWSTSOUND_WITH_MODPLUG=1
else
LOCAL_CFLAGS += -DUSE_SDL2 -DANDROID -DWINDSTILLE_NO_SOUND=1 -DWINDSTILLE_USE_GLES=1 -DWSTDISPLAY_USE_GLES=1 -DGLM_ENABLE_EXPERIMENTAL -DSURF_USE_STB_IMAGE=1
LOCAL_CPPFLAGS += -DUSE_SDL2 -DANDROID -DWINDSTILLE_NO_SOUND=1 -DWINDSTILLE_USE_GLES=1 -DWSTDISPLAY_USE_GLES=1 -DGLM_ENABLE_EXPERIMENTAL -DSURF_USE_STB_IMAGE=1 -std=c++23 -fexceptions -D_LIBCPP_ENABLE_EXPERIMENTAL=1
endif
