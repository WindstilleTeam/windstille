...
LOCAL_CFLAGS += -DUSE_SDL2 -DANDROID -DWINDSTILLE_USE_GLES=1
LOCAL_CPPFLAGS += -DUSE_SDL2 -DANDROID -DWINDSTILLE_USE_GLES=1 -std=c++23 -D_LIBCPP_ENABLE_EXPERIMENTAL=1
LOCAL_CFLAGS += -DWSTSOUND_WITH_MODPLUG=1
LOCAL_CPPFLAGS += -DWSTSOUND_WITH_MODPLUG=1
else
LOCAL_CFLAGS += -DUSE_SDL2 -DANDROID -DWINDSTILLE_NO_SOUND=1 -DWINDSTILLE_USE_GLES=1
LOCAL_CPPFLAGS += -DUSE_SDL2 -DANDROID -DWINDSTILLE_NO_SOUND=1 -DWINDSTILLE_USE_GLES=1 -std=c++23 -D_LIBCPP_ENABLE_EXPERIMENTAL=1
endif

LOCAL_CFLAGS += -DPRIO_USE_SEXPCPP=1 -DSEXP_USE_CXX17=1 -DTINYGETTEXT_UTF8_ONLY=1
LOCAL_CPPFLAGS += -DPRIO_USE_SEXPCPP=1 -DSEXP_USE_CXX17=1 -DTINYGETTEXT_UTF8_ONLY=1
