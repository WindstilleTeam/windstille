...
DecalObjectModel::add_control_points(std::vector<ControlPointHandle>& control_points)
{
  ...
  control_points.push_back(ControlPointHandle(new DecalScaleControlPoint(this, angle + 0*glm::pi<float>()/2, get_world_pos() + quad1.p1)));
  control_points.push_back(ControlPointHandle(new DecalScaleControlPoint(this, angle + 1*glm::pi<float>()/2, get_world_pos() + quad1.p2)));
  control_points.push_back(ControlPointHandle(new DecalScaleControlPoint(this, angle + 2*glm::pi<float>()/2, get_world_pos() + quad1.p3)));
  control_points.push_back(ControlPointHandle(new DecalScaleControlPoint(this, angle + 3*glm::pi<float>()/2, get_world_pos() + quad1.p4)));

  control_points.push_back(ControlPointHandle(new DecalScaleControlPoint(this, glm::pi<float>()/4 + angle + 0*glm::pi<float>()/2, get_world_pos() + quad3.p1, false, true)));
  control_points.push_back(ControlPointHandle(new DecalScaleControlPoint(this, glm::pi<float>()/4 + angle + 1*glm::pi<float>()/2, get_world_pos() + quad3.p2, true,  false)));
  control_points.push_back(ControlPointHandle(new DecalScaleControlPoint(this, glm::pi<float>()/4 + angle + 2*glm::pi<float>()/2, get_world_pos() + quad3.p3, false, true)));
  control_points.push_back(ControlPointHandle(new DecalScaleControlPoint(this, glm::pi<float>()/4 + angle + 3*glm::pi<float>()/2, get_world_pos() + quad3.p4, true,  false)));

  control_points.push_back(ControlPointHandle(new DecalRotateControlPoint(this, angle + 0*glm::pi<float>()/2, get_world_pos() + quad2.p1)));
  control_points.push_back(ControlPointHandle(new DecalRotateControlPoint(this, angle + 1*glm::pi<float>()/2, get_world_pos() + quad2.p2)));
  control_points.push_back(ControlPointHandle(new DecalRotateControlPoint(this, angle + 2*glm::pi<float>()/2, get_world_pos() + quad2.p3)));
  control_points.push_back(ControlPointHandle(new DecalRotateControlPoint(this, angle + 3*glm::pi<float>()/2, get_world_pos() + quad2.p4)));
}

void
